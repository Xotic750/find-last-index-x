 ...
 */
"use strict";var toLength=_dereq_("to-length-x"),toObject=_dereq_("to-object-x"),isString=_dereq_("is-string"),assertIsFunction=_dereq_("assert-is-function-x");module.exports=function findLastIndex(array,callback,thisArg){var object=toObject(array);assertIsFunction(callback);var index=toLength(object.length)-1;if(index<0)return-1;for(var isStr=isString(object);index>-1;){var item=isStr?object.charAt(index):object[index];if(callback.call(thisArg,item,index,object))return index;index-=1}return-1}},{"assert-is-function-x":2,"is-string":15,"to-length-x":25,"to-object-x":26}],2:[function(_dereq_,module,exports){/**
